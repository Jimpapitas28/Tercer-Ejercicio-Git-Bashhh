<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SessionVariable.aspx.cs" Inherits="SesionState.SessionVariable" %>
...
&nbsp;&nbsp;&nbsp;
        ...
        <p>
            <asp:Button ID="btnCofirm" runat="server" Height="30px" Text="Confirm" Width="93px" OnClick="btnCofirm_Click" />
        &nbsp;&nbsp;
            </p>
        </div>
    </form>
